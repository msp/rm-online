...
exports.stateList = function(country, selectedElementName){
    if (!country){
      country = "US"
    }
    ...
    if (country == "US") {
      ...
      var json = [{"data-alternative-spellings":"AB","name":"Alberta"},
                {"data-alternative-spellings":"BC","name":"British Columbia"},
                {"data-alternative-spellings":"LB","name":"Labrador"},
                {"data-alternative-spellings":"MB","name":"Manitoba"},
                {"data-alternative-spellings":"NB","name":"New Brunswick"},
                {"data-alternative-spellings":"NF","name":"Newfoundland"},
                {"data-alternative-spellings":"NS","name":"Nova Scotia"},
                {"data-alternative-spellings":"NU","name":"Nunavut"},
                {"data-alternative-spellings":"NW","name":"Northwest Territories"},
                {"data-alternative-spellings":"ON","name":"Ontario"},
                {"data-alternative-spellings":"PE","name":"Prince Edward Island"},
                {"data-alternative-spellings":"QC","name":"Quebec"},
                {"data-alternative-spellings":"SK","name":"Saskatchewen"},
                {"data-alternative-spellings":"YU","name":"Yukon"}]
    }
  ...
  // MSP
    if( !selectedElementName || selectedElementName.length < 1)
        html = '<option value="" selected="selected">type a state</option>\n';
