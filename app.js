...
TERMS = ["You shall use the Reports only for your own personal usage. You shall not provide the Reports to any other person.",
...
app.get('/terms', function(req, res) {
  res.render('terms', { title: 'Terms and Conditions', terms: TERMS });
});
