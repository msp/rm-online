...
<xsl:include href="http://localhost/ccards/common/includes/maintop.xsl"/>
  ...
  <body bgcolor="#FFFFFF" text="#333333">
	...
	<table align="center" width="602" border="0" cellspacing="0" cellpadding="0">
      <tr valign="top">
        ...
        <td> 
          <table align="center" width="600" height="100%" border="0" cellspacing="0" cellpadding="0" bordercolor="#999999">
            <tr> 
