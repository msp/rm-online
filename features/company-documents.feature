Feature: Company Documents
  ...
  Scenario: Executing a UK document search & viewing 50p docs
    When I visit the "company-documents/search" page
    And I execute a company search for "apiary"
    Then I should see 8 "documents" search results for "apiary"
    When I click through to "APIARY LONDON LIMITED"
    And I select the documents tab
    And I choose the RM 50p documents
    Then I should see the APIARY LONDON LIMITED accounts, returns & incorp documents
