Feature: UK and International business reports
  ...
  Scenario: Executing a UK report search & viewing Equifax reports
    When I visit the "uk-and-international-reports/search" page
    And I execute a company search for "radial solutions"
    Then I should see 1 "reports" search result for "radial solutions"
    When I click through to "RADIAL SOLUTIONS LTD"
    And I select the reports tab
    And I choose the Equifax reports
    Then I should see the RADIAL SOLUTIONS LTD full, snapshot & credit reports
